...
// var url = 'http://www.businessinsider.com/angellist-ceo-naval-ravikant-shares-his-favorite-books-2015-8#/%23meditations-by-marcus-aurelius-1';
...
// var url = 'http://www.harpersbazaar.com/celebrity/latest/news/a11988/mtv-vmas-2015-instagrams/';
...
// var url = 'http://www.businessinsider.com/chinas-air-pollution-is-in-a-bad-spot-2015-8';
// var url = 'http://www.techinsider.io/instagram-photos-from-inside-north-korea-2015-8';
...
// var url = 'http://www.businessinsider.com/hottest-tech-startups-in-america-2015-8';
...
// var url = 'http://www.businessinsider.com/the-highest-paying-jobs-at-facebook';
...
var url = 'http://www.buzzfeed.com/juliareinstein/night-showerers#.yqRR5v1Nr';
  ...
  function (err, article, res) {
    ...
    article.getHtmls([ { selector: 'link[rel="stylesheet"]', attr: 'href', tag: 'style' } ], function (err, html) {
      ...
      fs.writeFile('source.html', html, function (err) {
        ...
        console.log('source(%s) is saved!', html.length, new Date() - start);
      });
    });
